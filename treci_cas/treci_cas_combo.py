...
sadrzaj = [
    ...
    [
        sg.Combo(formiraj_listu_dd(24), size=(5, 5), default_value="00", enable_events=False, key='CASOVI'),
        sg.Text(":", font=("Digital-7", 25)),
        sg.Combo(formiraj_listu_dd(60), size=(5, 5), default_value="00", enable_events=False, key='MINUTI'),
        sg.Text("", size=(1, 0)),
